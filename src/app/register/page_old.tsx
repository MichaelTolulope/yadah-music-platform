...
//       // 2. Insert artiste_preferences row tied to the new user.
//       //    `id` is auto-generated by the DB default — do not set it here.
//       //    `user_id` is the FK to profiles(id), which is what actually
//       //    links this row to the signed-up user. Column is `iyadah_site`,
//       //    not `nearest_hub` — matches zamar_supabase_schema.sql exactly.
//       const { error: prefsError } = await supabase
//         .from("artiste_preferences")
//         .insert({
//           user_id: userId,
//           primary_genre: artisticFocus.primaryGenre,
//           languages: artisticFocus.languages,
//           iyadah_site: finalSanctuary.nearestHub,
//         });
...
//         throw new Error(
//           `Account created, but preferences could not be saved: ${prefsError.message}`
//         );
//       }
